...
export default class UsersDAO {
    static async injectDB(conn) {
        ...
        try {
            users = await conn.db(process.env.BOOKS_NS).collection("Users")
            sessions = await conn.db(process.env.BOOKS_NS).collection("Sessions")
        } catch (e) {
    ...
    */
    ...
    static async loginUser(email, jwt) {
        try {
            ...
            await sessions.updateOne({ someField: "someValue" }, { $set: { someOtherField: "someOtherValue" } }, )
            return { success: true }
        } catch (e) {
